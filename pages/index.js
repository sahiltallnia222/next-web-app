...
export default function Home() {
  return (
    <>
      ...
      <main>
        <div>
          <div className="xl:bg-[#0f172a] xl:text-white h-[30vh] xl:h-[50vh] flex flex-col gap-4 md:gap-16  justify-center">
            ...
            <Link href='/css-generators' className="w-64 mx-auto">
              <div className="hover:bg-blue-500 transition-colors duration-300 xl:text-black  xl:bg-white p-3 2xl:px-8 gap-4 sm:gap-0 flex items-center hover:text-white justify-center group">
