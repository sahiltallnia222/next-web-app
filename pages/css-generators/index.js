        ...
        <h1 className="text-3xl md:text-5xl text-blue-500 text-center font-semibold pb-5  pt-3">
          ...
          <div className="p-4 grid grid-cols-1 md:grid-cols-3 gap-4">
            <Link href='/css-generators/box-shadow' className={styles.boxShadow}>
              <div className="dark:text-white hover:text-blue-500 dark:hover:text-blue-500 transition-all duration-300  dark:bg-[#0f172a] py-14 shadow-md">
            ...
            <Link href='/css-generators/background-generator' className={styles.boxShadow}>
              <div className="dark:text-white hover:text-blue-500 dark:hover:text-blue-500 transition-all duration-300  dark:bg-[#0f172a] py-14 shadow-md">
                <p className="text-xl font-medium text-center">
